...
<label className='flex item-center gap-2'>
  <input type="checkbox" checked={experience.is_current || false} onChange={((e)   =>{updateExperience(index,
...
<div className="space-y-2">
  ...
  <textarea value={experience.description || ""} onChange={((e)  => updateExperience(index, "description", e.target.value))}
    rows={4} className="w-full text-sm px-3 py-2 rounded-lg
    resize-none" placeholder="Describe your key responsibilities and achievements..."></textarea>
</div>
