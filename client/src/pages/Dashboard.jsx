...
const Dashboard = () => {
  ...
  >
    <div className="size-11 flex items-center justify-center bg-gradient-to-br from-green-300 to-green-500 text-white rounded-full text-xl">
      📊
    </div>
        ...
        <div className="grid grid-cols-2 sm:flex flex-wrap gap-4">
          {allResumes.map((resume, index) => {
            ...
            return (
              ...
              >
                <FilePenLineIcon
                  className="size-7 group-hover:scale-105 color and it will sition-all"
          ...
          >
            ...
            >
              ...
              <input
                ...
                className="w-full px-4 py-2 mb-4 border-green-600 ring-green-600 focus:border-green-600 required"
              />
